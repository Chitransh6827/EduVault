            ...
            <div className="p-6">
              <div className="mb-2">
                ...
                {resource.accessPermission === 'private' && (
                  <span className="ml-2 px-2 py-1 bg-gray-800 text-white text-xs font-medium rounded-full">
                    Private
                  </span>
                )}
              </div>
          ...
          <div className="border-t border-gray-200 pt-6 mb-6">
            ...
            {isAuthenticated ? (
              ...
              <div className="bg-gray-50 p-4 rounded-md text-sm text-gray-600">
                <p>
                  <Link to="/login" className="text-pink-600 font-medium">Sign in</Link> to rate this resource.
                </p>
              </div>
            )}
          </div>
